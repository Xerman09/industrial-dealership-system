// This API route serves as a proxy to fetch VAT selling transactions from the Spring Boot backend.
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (!springRes.ok) {
      console.error('[VAT-SELLING] Upstream error:', springRes.status, springRes.statusText);
