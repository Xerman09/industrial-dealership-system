...
import GenerateTransmittalPage from "@/modules/financial-management/accounting/claims-management/generate-transmittals/components/GenerateTransmittalPage";
...
function pickString(obj: JwtPayload | null | undefined, keys: string[]): string {
    for (const k of keys) {
        const v = obj?.[k];
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">Claims Management</BreadcrumbLink>
                                </BreadcrumbItem>
