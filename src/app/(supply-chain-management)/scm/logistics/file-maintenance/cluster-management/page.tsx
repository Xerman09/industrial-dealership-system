...
import ClusterModule from "@/modules/supply-chain-management/logistics/file-maintenance/cluster-management/ClusterModule";
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">File Maintenance</BreadcrumbLink>
                                </BreadcrumbItem>
