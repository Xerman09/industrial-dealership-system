...
import StockTransferDispatchManualView from "@/modules/supply-chain-management/warehouse-management/stock-transfer/views/StockTransferDispatchManualView"
    ...
    return (
        <div className="flex h-full min-h-0 flex-col">
                ...
                <div className="flex items-center gap-2 px-4">
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator className="hidden md:block" />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Manual Dispatching</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
            ...
            <ScrollArea className="min-h-0 flex-1">
                <StockTransferDispatchManualView />
            </ScrollArea>
        </div>
    )
}
