// src/modules/financial-management/accounting/supplier-credit-memo/utils/index.ts

// ─── Constants ────────────────────────────────────────────────────────────────

export const API_BASE = "/api/fm/accounting/supplier-credit-memo";
...
export function getNextMemoNumber(lastNumber: string): string {
  ...
  return `SCM-${String(isNaN(num) ? 1 : num + 1).padStart(3, "0")}`;
}