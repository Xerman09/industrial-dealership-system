...
import type { OvertimeRequestWithDetails } from "../type";
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Complete details for the overtime request
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          {/* Overtime Period */}
          <div className="space-y-3 border-b pb-4">
            <h3 className="font-semibold text-sm">Overtime Period</h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-xs text-muted-foreground">From</p>
                <p className="font-medium">{formatTime(data.ot_from)}</p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">To</p>
                <p className="font-medium">{formatTime(data.ot_to)}</p>
              </div>
              <div>
